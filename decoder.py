...
if __name__ == "__main__":
    while True:
        print(f"[bold blue]Bs9 Decoder[/bold blue] [white on red][[/white on red][white on blue]VERSION[/white on blue] {version} [green]{date}[/green][white on red]][/white on red] [green]by[/green] [white on purple]Bishop9910[/white on purple]")
